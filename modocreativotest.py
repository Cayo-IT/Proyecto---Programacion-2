...
while True:
    ...
    if login_exitoso:
        ...
        while True: 
            ...
            print("[6] Salir (Cerrar sesión)")
            
            opcion_texto = input("Seleccione una opción: ")
                ...
                case 3:
                    ...
                    if not deposito_texto.isdigit():
                        ...
                        if monto <= 0:
                            ...
                            dinero += monto_neto
                            print(f"Se aplicó comisión del 10% (${comision:.2f}) por exceder $25,000.")
                            print(f"Depósito exitoso de ${monto_neto:.2f}. Su nuevo saldo es: ${dinero}")
                            nuevo_movimiento = f"Depósito: +${monto_neto:.2f} (Comisión: -${comision:.2f})"
                        else:
                            dinero += monto
                            print(f"Depósito exitoso. Su nuevo saldo es: ${dinero}")
